...
var hostReportErrors = __webpack_require__(103);
...
var ArrayIteratorMethods = __webpack_require__(47);
var createNonEnumerableProperty = __webpack_require__(8);
var wellKnownSymbol = __webpack_require__(1);
...
var iteratorClose = __webpack_require__(66);
...
var IS_IOS = __webpack_require__(70);
var IS_WEBOS_WEBKIT = __webpack_require__(101);
var IS_NODE = __webpack_require__(44);
...
var web_dom_collections_for_each = __webpack_require__(91);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.promise.js
var es_promise = __webpack_require__(62);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.object.to-string.js
var es_object_to_string = __webpack_require__(45);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.array.slice.js
var es_array_slice = __webpack_require__(72);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.function.name.js
var es_function_name = __webpack_require__(73);
...
var es_array_iterator = __webpack_require__(47);

// EXTERNAL MODULE: ./node_modules/core-js/modules/web.dom-collections.iterator.js
var web_dom_collections_iterator = __webpack_require__(85);
...
var SSE = /*#__PURE__*/function () {
  ...
  _createClass(SSE, [{
    ...
    value: function registerEvents() {
      ...
      var eventTypes = ['received', 'created', 'started', 'stopped', 'removed'];

      for (var _i = 0, _eventTypes = eventTypes; _i < _eventTypes.length; _i++) {
        var event = _eventTypes[_i];
        this.eventSource.addEventListener(event, function (e) {
          _this.dashboard.eventHandler(e);
        });
      }
    }
  }]);
...
var Fetch = /*#__PURE__*/function () {
  function Fetch(url) {
    Fetch_classCallCheck(this, Fetch);

    this.url = url;
  }

  Fetch_createClass(Fetch, [{
    key: "createRequest",
    value: function () {
      var _createRequest = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url, options) {
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return fetch("".concat(this.url).concat(url), options);
    ...
    value: function removeInstance(id) {
      return this.createRequest("/instances/".concat(id, "/").concat(this.user), {
        method: 'DELETE' // body: JSON.stringify({ user: this.user }),

      });
    }
  }, {
    key: "runInstance",
    value: function runInstance(id) {
      return this.createRequest("/instances/".concat(id), {
        method: 'PUT',
        body: JSON.stringify({
          action: 'run',
          user: this.user
    ...
    key: "stopInstance",
    value: function stopInstance(id) {
      return this.createRequest("/instances/".concat(id), {
        method: 'PUT',
        body: JSON.stringify({
          action: 'stop',
...
var es_regexp_to_string = __webpack_require__(116);

// CONCATENATED MODULE: ./src/js/DashboardRender.js
...
function DashboardRender_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function DashboardRender_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function DashboardRender_createClass(Constructor, protoProps, staticProps) { if (protoProps) DashboardRender_defineProperties(Constructor.prototype, protoProps); if (staticProps) DashboardRender_defineProperties(Constructor, staticProps); return Constructor; }

var DashboardRender = /*#__PURE__*/function () {
  function DashboardRender() {
    DashboardRender_classCallCheck(this, DashboardRender);

    var _document$getElements = document.getElementsByClassName('instance_list');

    var _document$getElements2 = _slicedToArray(_document$getElements, 1);

    this.instances = _document$getElements2[0];

    var _document$getElements3 = document.getElementsByClassName('worklog-record_list');

    var _document$getElements4 = _slicedToArray(_document$getElements3, 1);

    this.worklog = _document$getElements4[0];
  }

  DashboardRender_createClass(DashboardRender, [{
    key: "appendInstance",
    value: function appendInstance(server, status) {
      var instance = "\n    <div class=\"instance\" data-id=\"".concat(server, "\">\n      <div class=\"instance_id\">").concat(server, "</div>\n      <div class=\"instance_status\">\n        <span class=\"instance_label\">Status:</span>\n        <span class=\"instance_status_name status_").concat(status, "\">").concat(status, "</span>\n      </div>\n      <div class=\"instance_actions\">\n        <span class=\"instance_label\">Actions:</span>\n        <button class=\"instance_btn instance_").concat(status === 'running' ? 'stop' : 'run', "-btn\"></button>\n        <button class=\"instance_btn instance_remove-btn\"></button>\n      </div>\n    </div>");
      this.instances.insertAdjacentHTML('beforeend', instance);
    }
  }, {
    key: "appendRecord",
    value: function appendRecord(evt) {
      var _JSON$parse = JSON.parse(evt.data),
          info = _JSON$parse.info,
          server = _JSON$parse.server,
          date = _JSON$parse.date;

      var description = evt.type === 'received' ? "Received \"".concat(info, "\"") : info;
      var record = "\n    <div class=\"worklog-record\">\n      <div class=\"worklog-record_date\">".concat(this.getFormattedDate(date), "</div>\n      <div class=\"worklog-record_content\">\n        <p class=\"worklog-record_content_paragraph\">Server: ").concat(server, "</p>\n        <p class=\"worklog-record_content_paragraph\">INFO: ").concat(description, "</p>\n      </div>\n    </div>");
      this.worklog.insertAdjacentHTML('beforeend', record);
    }
  }, {
    key: "getFormattedDate",
    value: function getFormattedDate(dateNumber) {
...
function _createForOfIteratorHelper(o, allowArrayLike) { var it; if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (it = Dashboard_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e2) { throw _e2; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = o[Symbol.iterator](); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e3) { didErr = true; err = _e3; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }
...
function Dashboard_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function Dashboard_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { Dashboard_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { Dashboard_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
...
var Dashboard_Dashboard = /*#__PURE__*/function () {
  ...
  Dashboard_createClass(Dashboard, [{
    ...
    key: "appendInstances",
    value: function () {
      var _appendInstances = Dashboard_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var response, instances, _iterator, _step, item;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.fetch.getInstances();
      ...
      function appendInstances() {
        return _appendInstances.apply(this, arguments);
      }

      return appendInstances;
    }()
  }, {
    key: "subscribeToEventSource",
    value: function () {
      var _subscribeToEventSource = Dashboard_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var response, urlSSE;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return this.fetch.sendUser(this.user);

              case 2:
                response = _context2.sent;

                if (response.ok) {
                  urlSSE = "".concat(this.url, "/sse/").concat(this.user);
      ...
      function subscribeToEventSource() {
        return _subscribeToEventSource.apply(this, arguments);
      }
    ...
    value: function eventHandler(e) {
      ...
      if (status && status === 'changing') {
        var instance = document.querySelector("[data-id=\"".concat(server, "\"]"));
      ...
      switch (e.type) {
        ...
        case 'removed':
          var instanceToRemove = document.querySelector("[data-id=\"".concat(server, "\"]"));
          instanceToRemove.remove();
      }
    }
  }, {
    key: "changeInstanceStatus",
    value: function changeInstanceStatus(serverId, status) {
      // да, сплошные костыли
      var instance = document.querySelector("[data-id=\"".concat(serverId, "\"]"));

      var _instance$getElements = instance.getElementsByClassName('instance_status_name'),
          _instance$getElements2 = Dashboard_slicedToArray(_instance$getElements, 1),
          statusElem = _instance$getElements2[0];

      statusElem.classList.remove('status_stopped', 'status_running', 'status_changing');
      statusElem.classList.add("status_".concat(status));
      statusElem.textContent = status;

      if (status !== 'changing') {
        var btn = instance.querySelector('.instance_btn:first-of-type');
        btn.className = "instance_btn instance_".concat(status === 'running' ? 'stop' : 'run', "-btn");
        this.enableInstanceBtns(instance);
      }
    }
  }, {
    key: "disableInstanceBtns",
    value: function disableInstanceBtns(instance) {
      var btns = instance.getElementsByClassName('instance_btn');
      btns.forEach(function (btn) {
        btn.disabled = true;
      });
    }
  }, {
    key: "enableInstanceBtns",
    value: function enableInstanceBtns(instance) {
      var btns = instance.getElementsByClassName('instance_btn');
      btns.forEach(function (btn) {
        btn.disabled = false;
      });
    ...
    value: function registerEvents() {
      ...
      var _document$getElements = document.getElementsByClassName('instances_create-btn'),
          _document$getElements2 = Dashboard_slicedToArray(_document$getElements, 1),
          createBtn = _document$getElements2[0];

      createBtn.addEventListener('click', function () {
        return _this.fetch.createInstance();
      });
      document.addEventListener('click', function (_ref) {
        var target = _ref.target;
        var instance = target.closest('.instance');
        if (!instance) return;
        var instanceId = instance.dataset.id;

        if (target.classList.contains('instance_remove-btn')) {
          _this.fetch.removeInstance(instanceId);
        }

        if (target.classList.contains('instance_run-btn')) {
          _this.fetch.runInstance(instanceId);
        }

        if (target.classList.contains('instance_stop-btn')) {
          _this.fetch.stopInstance(instanceId);
        }
      });
    }
  }]);
...
var app_url = 'https://ahj-cloud-dashboard.herokuapp.com';
var dashboard = new Dashboard_Dashboard(app_url);
dashboard.init();
